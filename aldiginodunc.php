...
if ($_SESSION["gir"] == 1){
    ...
    <div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
        ...
        <div class="main-content" style="margin: 0 0 100px; padding-bottom: 50px;">
            ...
            <h2 style="padding-top: 50px; padding-bottom:50px;">Ödünçler</h2>
            <br />
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <table class="table table-bordered table-striped datatable" id="table-2">
                        ...
                        $query = 'SELECT `odunc_no`,`isbn`, `balangic_tarihi`, `bitis_tarihi`, `odunc_suresi` FROM `odunc_alma` 
                                  WHERE `uye_no` = :uyeno AND `odunc_iade` = 0 ';
                        ...
                        while ($row = $sth->fetch(PDO::FETCH_ASSOC)){
                            $i += 1;
                            echo "<tr>";
                            $ve = array(':isbn'=>$row['isbn']);
                            $qq = 'SELECT `kitap_adi` FROM `kitap` WHERE `isbn` = :isbn';
                            $st = $dbh->prepare($qq);
                            $st->execute($ve);
                            $kitapadi = $st->fetchAll(PDO::FETCH_COLUMN, 0);
                            echo "<td>".$kitapadi[0]."</td>";
                            echo "<td>".$row['balangic_tarihi']."</td>";
                            echo "<td>".$row['bitis_tarihi']."</td>";
                            echo "<td>".$row['odunc_suresi']."</td>";
                            echo "<td><a href=\"javascript:;\" onclick=\"iade(".$row['odunc_no'].")\" class=\"btn btn-info btn-sm btn-icon icon-left\">
                                    <i class=\"entypo-pencil\"></i>iade</a></td>";
                        }
                        ?>
                        </tbody>
                    </table>
                    <?php
                    if ($i == 0){
                        echo "<h2 style=\"text-align: center;\">Odunc Bulunamadi</h2>";
                    }
        ...
        <div>
            <!-- Footer -->
            <footer class="main" style="position: absolute; left: 300px; bottom: 5px;">
        ...
        <div class="modal-dialog">
            <div class="modal-content" style=" width: 500px;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="col-sm-6 control-label">Date Picker (popup)</label>
                                <div class="col-sm-6">
                ...
                <div class="modal-footer">
                    ...
                    <button id ="odunc" type="button" class="btn btn-info">Save changes</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="assets/js/odunciade.js"></script>
