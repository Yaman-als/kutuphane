...
if ($_SESSION["gir"] == 1){
    ...
    <div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
        ...
        <div class="main-content" style="margin: 0 0 100px; padding-bottom: 40px;">
            ...
            <h2 style="padding-top: 10px; padding-bottom:0px;  ">Üyelik</h2>
            <br class="row">
                <br class="col-md-12">
                        ...
                        <div class="panel-body">
                            <form role="form" class="form-horizontal form-groups-bordered">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="sifre-1" placeholder="Yeni Şifre">
                                    </div></br></br></br>
                                    <label for="field-1" class="col-sm-3 control-label"></label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="sifre-2" placeholder="Yeni Şifre Tekrarı">
                                    </div>
                                    <a href="javascript: sifredegistir();" class="btn btn-primary">
                                        Şifre Değiştir
                                    </a>
                                </div>
                            </form>
                        ...
                        <div class="panel panel-primary" data-collapsed="0">
                            ...
                            <div class="panel-body">
                                <table class="table table-bordered table-striped datatable" id="table-2">
                                    ...
                                    <tbody>
                                    <?php
                                    $da = array(':uyeno'=>$_SESSION['logged_user']);
                                    $qq = "SELECT `no`, `tel` FROM `uye_tel` WHERE `uye_no` = :uyeno";
                                    $sor = $dbh->prepare($qq);
                                    $sor->execute($da);
                                    while ($row = $sor->fetch(PDO::FETCH_ASSOC)){
                                        ...
                                        echo "<td>Tel</td>";
                                        echo "<td>".$row['tel']."</td>";
                                        echo "<td><a href=\"javascript:;\" onclick=\"siltel(".$row['no'].")\" class=\"btn btn-danger btn-sm btn-icon icon-left\">
                                                <i class=\"entypo-cancel\"></i>Sil</a></td>";
                                        echo "</tr>";
                                    }
                                    $qq = "SELECT `no`, `eposta` FROM `uye_eposta` WHERE `uye_no` = :uyeno";
                                    $sor = $dbh->prepare($qq);
                                    $sor->execute($da);
                                    while ($row = $sor->fetch(PDO::FETCH_ASSOC)){
                                        echo "<tr>";
                                        ...
                                        echo "<td><a href=\"javascript:;\" onclick=\"sileposta(".$row['no'].")\" class=\"btn btn-danger btn-sm btn-icon icon-left\">
                                                <i class=\"entypo-cancel\"></i>Sil</a></td>";
                                        echo "</tr>";
                                    }
                                    ?>
                                ...
                                <a href="javascript:;" onclick="jQuery('#modal-6').modal('show',
                                                {backdrop: 'static'});" class="btn btn-primary">
            ...
            <div class="modal-content" style=" width: 500px;">
                ...
                <div class="modal-body" >
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Kayıt Türü</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Kayıt</label>
                                <div class="col-sm-8">
                ...
                <div class="modal-footer">
                    ...
                    <button id ="telpost" type="button" class="btn btn-info">Ekle</button>
                </div>
            </div>
        </div>
    </div>

    <script src="assets/js/uyelik.js"></script>
