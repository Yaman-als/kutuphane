					...
					neonRegister.setPercentage(98, function()
					{
						...
						$.ajax({
							...
							success: function(response)
								...
								var adi = response.submitted_data.adi,
									soyad = response.submitted_data.soyad,
									telno = response.submitted_data.telno,
									tcno = response.submitted_data.tcno,
                                    kullaniciadi = response.submitted_data.kullaniciadi,
